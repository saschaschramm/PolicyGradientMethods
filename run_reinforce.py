...
def main():
    ...
    stats_recorder = StatsRecorder(summary_frequency=1000, performance_num_episodes=100)
    ...
    for t in range(timesteps):
        ...
        if done:
            ...
            for observation, reward, action in zip(observations, rewards, actions):
                discounted_reward = pow(discount_rate, i) * discount(rewards, discount_rate, i)
